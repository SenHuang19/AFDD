...
equation
  ...
  connect(gain.y, Loa) annotation (Line(points={{88.4,30},{96,30},{96,0},{110,0}},
        color={0,0,127}));
  connect(HW_temp, toDegC.Kelvin) annotation (Line(points={{-120,0},{-92,0},{
          -92,0},{-62,0}}, color={0,0,127}));
  connect(toDegC.Celsius, building_fmu_fmu1.HW_temp)
    annotation (Line(points={{-39,0},{-12.4,0},{-12.4,0}}, color={0,0,127}));
